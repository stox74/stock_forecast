...
# CSV 저장 경로 설정
# ================================
SAVE_CSV = False  # CSV 저장 여부: True=저장, False=DB만 저장
...
# 0번째부터 99번째까지 (100개)
# python run_trade_adv_forecast_v3_part1.py --range 0:100
# 시작만 지정 (끝은 리스트 끝까지)
# python run_trade_adv_forecast_v3_part1.py --start 0
# # 끝만 지정 (처음부터 지정 인덱스까지)
# python run_trade_adv_forecast_v3_part1.py --end 100
# # 시작과 끝 모두 지정
# python run_trade_adv_forecast_v3_part1.py --start 100 --end 200
# 터미널 1
