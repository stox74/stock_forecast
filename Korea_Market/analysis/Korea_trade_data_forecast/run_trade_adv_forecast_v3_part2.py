...
# 6. 실행
# ================================
PART_NUMBER = 2   # 이 파일의 파트 번호 (1, 2, 3 중 하나)
TOTAL_PARTS = 3   # 전체 파트 수

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='무역 데이터 예측 배치 프로세스 - Part 2/3')
...
# 0번째부터 99번째까지 (100개)
# python run_trade_adv_forecast_v3_part2.py --range 0:100
# 시작만 지정 (끝은 리스트 끝까지)
# python run_trade_adv_forecast_v3_part2.py --start 0
# # 끝만 지정 (처음부터 지정 인덱스까지)
# python run_trade_adv_forecast_v3_part2.py --end 100
# # 시작과 끝 모두 지정
# python run_trade_adv_forecast_v3_part2.py --start 100 --end 200
# 터미널 1
