...
if __name__ == "__main__":
    ...
    if args.range:
        try:
            ...
            print("[오류] --range 형식이 잘못되었습니다. 예: --range 334:667")
            sys.exit(1)
    ...
    if args.start is None and args.end is None and args.range is None:
        ...
        args.start = (PART_NUMBER - 1) * chunk                              # total_count // 3
        args.end   = PART_NUMBER * chunk if PART_NUMBER < TOTAL_PARTS else total_count  # (total_count // 3) * 2
