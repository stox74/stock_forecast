...
# # 끝만 지정 (처음부터 지정 인덱스까지)
# python run_trade_data_adv_forecast.py --end 100
# # 시작과 끝 모두 지정
# python run_trade_data_adv_forecast.py --start 100 --end 200
# 터미널 1
# python run_trade_data_adv_forecast.py --range 0:167
#
# 터미널 2
# python run_trade_data_adv_forecast.py --range 167:334
#
# 터미널 3
# python run_trade_data_adv_forecast.py --range 334:500